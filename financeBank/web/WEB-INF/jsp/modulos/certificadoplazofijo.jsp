    ...
    <head><link rel="shortcut icon" href="./images/favicon.ico" />
        ...
        //System.out.println("entro certificadoPlazoFijo.jsp");
            ...
            if (session.isNew()) {
                ...
                TFilial filial = (TFilial) d.load(TFilial.class, session.getAttribute("USER_CODFILIAL").toString());
                idcertificado = request.getParameter("certificadoplazofijoGen");
                if (tmp != null) {
                    FileManager fm = new FileManager();
                    if (idcertificado != null) {
                        StringBuffer sb = new StringBuffer();
                        tcertificado = (TCertificado) d.load(TCertificado.class, idcertificado);
