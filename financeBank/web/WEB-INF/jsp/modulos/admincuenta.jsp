...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="js/scriptshow/scriptAdmCuenta.js"></script>
        <style type="text/css">
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td><input type="text" id="txtTempSelTipB" name="txtTempSelTipB" value="" style="display:none">
                                                                        ...
                                                                        <select id="selTipoBus" name="selTipoBus" onchange="validartxtBusquedaa();" >
                                                                    ...
                                                                    <td colspan="4"><input id="btnBuscarCtas" type="button" value="BuscarCuenta" onclick="vercuentaa()" /></td>
                                                                </tr>
                                                            </table>
                                                        </fieldset>
                                                    </td>
