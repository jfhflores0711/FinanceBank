<%-- 
    Document   : pruebafeedback
    Created on : 30-abr-2010, 12:02:57
    Author     : oscar
--%>
...
<head>
    ...
    <meta content="0;URL=principal.htm" http-equiv="REFRESH">
    ...
    <div id="content">
        ...
        <div id="main2">
            <div id="welcome" class="post">
                ...
                <div class="story">
                    <p><h1 class="req">Gracias por enviar sus comentarios.</h1>
                </div>
            </div>
        </div>
    </div>
