...
public class SRetiroOtro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            TLogFinance detallecaja = (TLogFinance) dao.load(TLogFinance.class,"LOG" + myCaja + monedaObj.getCodMoneda());
            ...
            detallecaja.setActivoCajaybanco(detallecaja.getActivoCajaybanco().subtract(new BigDecimal(importe)));
            detallecaja.setMonto(detallecaja.getMonto().subtract(new BigDecimal(importe)));
            detallecaja.setPatrimonio(detallecaja.getPatrimonio().subtract(new BigDecimal(importe)));
            dao.update();
            ...
            operacion.setSaldoFinalSinInteres(detallecaja.getMontoFinal());
