 ...
 * @author ronald
 */
public class SReciboTransferencia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String idt = (String) session.getAttribute("ID_TRANSFERENCIA");
            int n = 0;
            while (idt == null && n < 5) {
                ...
                n++;
                idt = (String) session.getAttribute("ID_TRANSFERENCIA");
            }
            TTransferenciaCaja trnscj = (TTransferenciaCaja) d.load(TTransferenciaCaja.class, idt);
            if (trnscj == null) {
                out.print("ERROR EN LECTURA DE DATOS, LA OPERACION AUN SE REALIZO");
                out.close();
                return;
            }
            ...
            for (int i = 0; i < 3; i++) {
                if (i == 0 || i == 2) {
                    ...
                    out.println("</tr>");
                    out.println("<tr>");
                    out.println("<td colspan='3'><font size='2'><b> OPERACION : TRANSFERENCIA </b></font> </td>");
                    out.println("</tr>");
                    out.println("<tr>");
                    ...
                    out.println("</tr>");
                    TCaja cds = (TCaja) d.load(TCaja.class, trnscj.getCodCajaDestino());
                    out.println("<tr>");
